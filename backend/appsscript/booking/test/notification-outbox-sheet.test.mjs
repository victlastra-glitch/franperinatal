...
const booking = {
  rowNumber: 2,
  reservation_id: 'fran-nonprod-20260821-reservation-sheet',
  idempotency_key: 'fran-nonprod-20260821-sheet-key-0001',
  commerce_order: 'npo-dddddddddddddddddddddddddddddddddddddddd',
...
check(spreadsheet.getSheetByName('reservations_nonprod') === reservationSheet, 'reservations_nonprod exists');
check(spreadsheet.getSheetByName('notification_outbox_nonprod') === null, 'notification_outbox_nonprod is initially absent');
...
console.log('EXISTING_NONPROD_SCHEMA_COMPATIBILITY=PASS');
