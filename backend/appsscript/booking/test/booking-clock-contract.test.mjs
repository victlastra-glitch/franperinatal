...
check(created.ok === true && created.paymentUrl.startsWith('https://sandbox.flow.cl/app/web/pay'),
...
['now', 'nowMs', 'testNow', 'clock'].forEach((key, index) => {
  const poisoned = {
    ...validPayload,
    idempotencyKey: `fran-nonprod-20260821-123e4567-e89b-12d3-a456-42661417400${index}`,
