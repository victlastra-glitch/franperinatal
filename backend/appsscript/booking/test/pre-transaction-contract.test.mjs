...
resources.calendarGateway.createLinkedBookingEvent({
  calendar_link_key: 'fran-booking-calendar-link-synthetic',
...
resources.calendarGateway.updateSameEvent({ calendar_event_id: 'event-opaque', calendar_event_etag: 'etag-1', calendar_link_key: 'fran-booking-calendar-link-synthetic' },
...
const invalidPayload = { ...payload, idempotencyKey: 'fran-booking-123e4567-e89b-12d3-a456-426614174001', date: '2026-08-30' };
