...
const statusToken = 'fran-booking-st-0123456789abcdef0123456789abcdef';
...
try {
  const response = await workerModule.default.fetch(
    ...
    { APP_ENV: 'production', APPS_SCRIPT_WEB_APP_URL: 'https://script.google.com/macros/s/SYNTHETIC_PRODUCTION' },
    {}
  );
